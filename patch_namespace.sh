...
# Set the vCenter 
VCENTER="sc3-vc-01.haas-232.pez.pivotal.io"
...
if [ -z "$VCENTER_API_SESSION_ID" ]; then
	...
	--header 'Authorization: Basic YWRtaW5pc3RyYXRvckB2c3BoZXJlLmxvY2FsOllZI2VYcGE3RUouUDhvRXo2PUNW' \
	| jq -r '.value' )
fi
    ...
    "access_list": [
        {
            "role": "OWNER",
            "subject_type": "USER",
            "subject": "'${KUBECTL_VSPHERE_USERNAME}'",
